...
class seteukBasicProto:
  ...
  * Details
    ...
    - Main Activities<<<주요 활동>>> -> Provide a detailed, step-by-step description of the activity or experiment. Provide a title for each activity, followed by a detailed description of the methods and procedures involved.
...
class seteukBasicBodyTop:
    ...
    * Always use honorific language (polite speech) like '~입니다'. '~합니다'.  
